...
Phase 7 still does not run a long-lived daemon. Idle/adoption/SET/INFORM RSS
...
state, INFORM, and platform adapters. The Phase 7 row mainly confirms that
packaging/staging code did not affect the current stub executable; it is not a
